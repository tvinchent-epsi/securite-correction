...
if(isset($_POST['ajouterMot'])){
    // Utilisation de la fonction htmlspecialchars en entrée, pour éviter les attaques XSS
...
foreach ($result as $ligne) {
    // Utilisation de la fonction htmlspecialchars en sortie, pour éviter les attaques XSS
    echo htmlspecialchars($ligne['mot']) . '<br>';
}
